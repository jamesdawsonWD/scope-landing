  ...
  return (
    ...
    >
      <div className={`relative p-8 rounded-2xl border transition-all duration-300 ${
        isAvailable 
          ? 'bg-card border-card-border hover:border-white/30 cursor-pointer' 
          : 'bg-card/50 border-card-border/50 cursor-not-allowed'
      }`}>
        {/* Gradient glow for available */}
        {isAvailable && (
        ...
        <div className="relative flex flex-col items-center text-center">
          ...
          {/* Platform name */}
          <h3 className={`text-xl font-semibold mb-2 ${!isAvailable && 'text-muted'}`}>
            {platform.name}
          </h3>
