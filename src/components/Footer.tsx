...
import { footer, navigation } from '@/content/copy'
import { trackSocialClick, trackFooterLink, trackLogoClick } from '@/lib/analytics'
    ...
    <footer className="relative pt-20 pb-8 border-t border-card-border">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
              ...
              {footer.social.map((social) => {
                ...
                return (
                  <motion.a
                    ...
                    onClick={() => trackSocialClick(social.platform, social.href, 'footer')}
                  >
                ...
                {links.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      onClick={() => trackFooterLink(link.label, link.href, category)}
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="pt-8 border-t border-card-border/50 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted">
            {footer.builtBy.replace('♥', '')}
            <span className="gradient-text">♥</span>
            {footer.builtBy.split('♥')[1]}
          </p>
        </div>
      </div>
    </footer>
